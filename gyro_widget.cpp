...
void gyro_widget::drawGrid(QPainter *painter)
{
  ...
  painter->drawRect(0,60,60,height()-120);//    left
  painter->drawRect(60,0,width()-120,60);//    top
  painter->drawRect(width()-60,60,59,height()-120);//  right
  painter->drawRect(60,height()-60,width()-120,59);//  bottom
}
