...
/*
 * Note from authors of WinlabEEG: 
 *	This code is copied wholesale from the above R package nnet. No modifications have been done to it on the part
 * 	of the WinlabEEG authors. The only thing that our program does is use the compiled source and we claim no 
 *	credit for any of the fine work done by Misters Venables and Ripley in putting this code together.
 */
